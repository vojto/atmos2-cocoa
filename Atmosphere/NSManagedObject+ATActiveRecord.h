//
//  RKManagedObject+ATActiveRecord.h
//
//  Adapted from https://github.com/RestKit/RestKit
//  which adapted from https://github.com/magicalpanda/MagicalRecord
...
@interface NSManagedObject (ATActiveRecord)
